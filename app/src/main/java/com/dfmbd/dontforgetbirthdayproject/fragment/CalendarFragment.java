...
import com.dfmbd.dontforgetbirthdayproject.calenderDecorators.EventDecorator;
import com.dfmbd.dontforgetbirthdayproject.calenderDecorators.SaturdayDecorator;
import com.dfmbd.dontforgetbirthdayproject.calenderDecorators.SundayDecorator;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                calendarView.addDecorator(new EventDecorator(Color.RED, Collections.singleton(CalendarDay.from(nowYear,month,day))));
