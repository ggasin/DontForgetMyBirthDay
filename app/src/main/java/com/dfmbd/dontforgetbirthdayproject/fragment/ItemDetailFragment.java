...
import com.dfmbd.dontforgetbirthdayproject.apiClass.GetLunarSolarApiManager;

import com.dfmbd.dontforgetbirthdayproject.apiClass.IsSolarValidApiManager;
import com.dfmbd.dontforgetbirthdayproject.apiClass.LoadingApiManager;
import com.dfmbd.dontforgetbirthdayproject.apiClass.SetAlarmApiManager;
import com.dfmbd.dontforgetbirthdayproject.request.ItemUpdateRequest;
...
import com.dfmbd.dontforgetbirthdayproject.request.ItemDeleteRequest;
...
public class ItemDetailFragment extends Fragment {
    ...
    private LinearLayout itemDetailBtnLy,itemDetailEditNameLy,progressBarLy,itemDetailTopLy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        itemDetailTopLy = rootView.findViewById(R.id.item_detail_top_ly);
                                ...
                                public void onSuccess(ArrayList<String> result) {
                                    ...
                                    if(lunarArr.get(1).equals("윤")){
                                        ...
                                        Thread solarThread = new Thread(new Runnable() {
                                            @Override
                                            public void run() {
                                                solarArr = getLunarSolarApiManager.getSolar(String.valueOf(nowYear),lunarArr.get(2),lunarArr.get(0));
                                                // 1월 초반 생일자가 음력체크를 할때 이번년도에 해당하는 음력이 없으면 양력으로 변환할때 다음년도로 넘어가서 계산하게 됨.
                                                if (Integer.parseInt(solarArr.get(2)) > nowYear) {
                                                    solarArr = getLunarSolarApiManager.getSolar(String.valueOf(nowYear - 1), lunarArr.get(2), lunarArr.get(0));
                                                }
    ...
    public void editModeOn(){
        ...
        itemDetailTopLy.setVisibility(View.GONE);
    ...
    public void editModeOff(){
        ...
        itemDetailTopLy.setVisibility(View.VISIBLE);
        if(mainActivity.itemlunarBirth.equals("--") || mainActivity.itemlunarBirth.equals("윤달")){
            itemDetailLunar.setText(mainActivity.itemlunarBirth);
